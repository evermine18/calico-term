    ...
    <ToastContext.Provider value={{ toast }}>
      ...
      <div className="fixed bottom-12 right-4 z-[60] flex flex-col gap-2 pointer-events-none">
        {toasts.map((t) => (
          <div
            key={t.id}
            className="pointer-events-auto flex items-start gap-2 max-w-sm rounded-lg border border-slate-700/60 bg-slate-900/95 px-3 py-2 shadow-xl shadow-black/40 backdrop-blur-md animate-in slide-in-from-right-4 fade-in duration-200"
          >
